...
Communication of the reference generated by the vision controller to the robot is done over an UDP socket. The message consists of the number of total reference variables andeach of those variables, as shown below:
