...
* *robot_workspace/src/PlotJuggler*: Holds the [PlotJuggler](https://github.com/facontidavide/PlotJuggler) package, which is used to visualize data published by ROS topics.
