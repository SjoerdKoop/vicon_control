...
* *vicon_workspace/vicon_datastream_sdk*: Holds the relevant headers and libraries from the [Vicon Datastream SDK](https://www.vicon.com/downloads/utilities-and-sdk/datastream-sdk) [MIT License](https://opensource.org/licenses/MIT)
...
* *robot_control/pru-icss*: Holds the PRU linker command file relevant headers of the PRU-ICSS generated by the [Linux Processor SDK for AM335x](http://software-dl.ti.com/processor-sw/esd/PROCESSOR-SDK-LINUX-AM335X/latest/index_FDS.html)
